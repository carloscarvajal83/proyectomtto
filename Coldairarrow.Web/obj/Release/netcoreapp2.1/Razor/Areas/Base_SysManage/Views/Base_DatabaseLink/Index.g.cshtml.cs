#pragma checksum "C:\Users\ADMIN\source\repos\Coldairarrow\Coldairarrow.Web\Areas\Base_SysManage\Views\Base_DatabaseLink\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "dc46858e0ae7b4f48a05cdb0d0243933cdc890ed"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"dc46858e0ae7b4f48a05cdb0d0243933cdc890ed", @"/Areas/Base_SysManage/Views/Base_DatabaseLink/Index.cshtml")]
    public class Areas_Base_SysManage_Views_Base_DatabaseLink_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#line 1 "C:\Users\ADMIN\source\repos\Coldairarrow\Coldairarrow.Web\Areas\Base_SysManage\Views\Base_DatabaseLink\Index.cshtml"
  
    Layout = "~/Views/Shared/_Layout_List.cshtml";

#line default
#line hidden
            BeginContext(56, 4899, true);
            WriteLiteral(@"
...
<script>
    ...
    function initTable() {
        $table.bootstrapTable({
            url: '/Base_SysMa");
            WriteLiteral(@"nage/Base_DatabaseLink/GetDataList',
            idField: 'Id',
            pagination: true,
            method: 'post',
            clickToSelect: false,
            ...
            columns: [
                ...
                { title: '数据库类型', field: 'DbType', width: '10%' },
                {
                    title: '操作', field: '_', width: '27%', formatter: function (value, row) {
                        ...
                        builder.AddBtn({ icon: 'glyphicon");
            WriteLiteral(@"-trash', function: 'deleteData', param: [row['Id']] });
    ...
    function openForm(id, title) {
        dialogOpen({
            ...
            title: title,
            btn: ['确定', '取消'],
            url: '/Base_SysManage/Base_DatabaseLink/Form?id={0}'.format(id || ''),
    ...
    function deleteData(id) {
        dialogComfirm('确认删除吗？', function () {
            ...
            if (typeof (id) == 'string') {//单条数据
                ...
                var rows = $tab");
            WriteLiteral(@"le.bootstrapTable('getSelections');
                if (rows.length == 0) {
            ...
            loading();
            $.postJSON('/Base_SysManage/Base_DatabaseLink/DeleteData', { ids: JSON.stringify(ids) }, function (resJson) {
                loading(false);
