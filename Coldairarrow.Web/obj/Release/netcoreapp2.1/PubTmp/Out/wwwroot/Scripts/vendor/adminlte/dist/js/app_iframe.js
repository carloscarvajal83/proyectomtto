...
function findTabTitle(pageId) {
    ...
    $(".page-tabs-content").find("a.menu_tab").each(function () {
        ...
        if ($a.attr(pageIdField) == pageId) {
            $ele = $a;
            //var $bartitle = $ele.find('.page_tab_title');
            //var $titulo = $bartitle.text();
            //$("#tituloforma").text($titulo.toUpperCase());
            return false;//退出循环
        }
    });
    return $ele;
...
var addTabs = function (options) {
    ...
    if (findTabPanel(pageId) === null) {
        ...
        //var $bartitle = $("#tituloforma").text(options.title.toUpperCase());
...
function closeTabByPageId(pageId) {
    ...
    if ($title.hasClass("active")) {
        ...
        if ($nextTitle.size() > 0) {
            ...
            var apid1 = activePageId;
        } else {
            activePageId = getPageId($title.prev());
            var apid2 = activePageId;
        }
...
function activeTabByPageId(pageId) {
    ...
    scrollToTab($title[0]);
    var $bartitle = $title.find('.page_tab_title');
    var $titulo = $bartitle.text();
    $("#tituloforma").text($titulo.toUpperCase());
    var $okey = 1;
}
